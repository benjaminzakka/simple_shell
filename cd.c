...
/**
 * cd_to - switches to a directory given
 * by the user
 *
 * @datash: data specified (directories)
 * Return: Null
 */
...
/**
 * cd_previous - switches to the previous directory
 *
 * @datash: data specified (environ)
 * Return: Null
 */
...
/**
 * cd_to_home - switches to home directory
 *
